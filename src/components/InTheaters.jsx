...
function InTheaters() {
  ...
  if (loading) {
    return <section className="section"><p className="loading-text">Loading In Theaters...</p></section>;
  }
    ...
    return (
      <section className="section">
        <div className="container">
          <h2 className="section-title"><span className="title-bar"></span>In Theaters</h2>
